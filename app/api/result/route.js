...
export async function POST(request) {
  ...
  try {
    const programSql = `SELECT * FROM programs WHERE status='judged'`;
    ...
    const responseData =await Promise.all(
        ...
        const programListSql = `SELECT * FROM programList WHERE program=${program.id} AND status='finished' ORDER BY mark DESC`;
