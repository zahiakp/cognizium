  ...
  return (
    <Modal close={() => close(false)}>
      <div className="flex flex-col gap-3 max-w-[400px]">
        <h6 className="font-semibold text-xl  w-full text-center">
          {program?.name}
        </h6>
       ...
       <div className="flex items-start gap-3 border border-red-300 text-red-600 bg-red-50 px-6 py-4 rounded-lg">
      <div className="mt-1 text-red-500">
        <HiExclamationTriangle size={24} />
      </div>
      <div>
        <h3 className="font-semibold text-red-700 mb-1">Dangerous Action</h3>
        <p className="text-sm leading-relaxed">
          You are about to <span className="font-semibold">reset this program</span>. 
          This will permanently remove <span className="underline">all related data</span>, 
          including participants, results, and scores. This action <strong>cannot be undone.</strong>
        </p>
      </div>
    </div>
